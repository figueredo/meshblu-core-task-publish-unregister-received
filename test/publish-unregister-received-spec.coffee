...
PublishUnregisterReceived = require '..'

describe 'PublishUnregisterReceived', ->
  beforeEach ->
    @redisKey = uuid.v1()
    ...
    @sut = new PublishUnregisterReceived options, dependencies
      ...
      beforeEach (done) ->
        request =
          metadata:
            ...
            route: [
              {type: 'unregister.sent',     from: 'sender-uuid',   to: 'receiver-uuid'}
              {type: 'unregister.received', from: 'receiver-uuid', to: 'receiver-uuid'}
            ]
