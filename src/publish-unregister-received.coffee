...
class PublishUnregisterReceived
  constructor: (options={}) ->
    {
      @firehoseClient
      @uuidAliasResolver
  ...
  do: (request, callback) =>
    ...
    return @_doCallback request, 204, callback unless lastHop.from == lastHop.to && lastHop.type == 'unregister.received'
...
module.exports = PublishUnregisterReceived
